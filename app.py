...
client = OpenAI(
    ...
    api_key=os.getenv("	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")
)
...
You are strictly not supposed to answer anything unrelated to BEEE and bluntly refuse to answer stating the reason that your prime existance is to help in BEEE and not in any other subject or domain"."  # Replace with your real prompt
